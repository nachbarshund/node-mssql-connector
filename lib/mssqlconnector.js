  ...
  MSSQLRequestBase = (function(_super) {
    ...
    */
    ...
    MSSQLRequestBase.prototype._addINStatement = function(field, datatype, value) {
      ...
      this.statement = this.statement.replace("@" + field, statement);
      this._setParams();
    ...
    */
    ...
    MSSQLRequestBase.prototype._checkParams = function() {
      ...
      if ((paramkeys != null ? paramkeys.length : void 0) !== ((_ref = this._fields) != null ? _ref.length : void 0)) {
        this._handleError(null, 'param-field-length', 'The length of given params is different to set parameters');
        return false;
      }
      _ref1 = this._fields;
